const API_KEY = "f025a209e480037b6447c6a32e82bf75";

const request = {
  fetchTrending: `trending/all/week?api_key=f025a209e480037b6447c6a32e82bf75`,
  ...
  fetchDocumentries: `discover/movie?api_key=${API_KEY}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_genres=99`,
};
